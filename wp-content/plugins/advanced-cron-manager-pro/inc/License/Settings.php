...
class Settings {
	...
	/**
	 * Displays the activation prompt
	 *
	 * @param  object $view instance of parent view
	 * @return void
	 */
	public function display_activate_prompt() {
		...
		$this->view->set_var( 'license', $this->manager->check_license() );
		$this->view->get_view( 'license-activate-prompt' );
