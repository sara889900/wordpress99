...
class Manager {
	...
	public function ajax_activate() {
		...
		$this->ajax->response( __( 'License has been activated. Refreshing the page...', 'advanced-cron-manager' ), $errors );
	...
	public function ajax_deactivate() {
		...
		$this->ajax->response( __( 'License has been deactivated. Refreshing the page...', 'advanced-cron-manager' ), $errors );
